...
async function waitForResumeReady(
    ...
    while (Date.now() < deadline) {
        pollCount += 1;
        // eslint-disable-next-line no-await-in-loop -- polling is intentionally sequential.
        ...
        // eslint-disable-next-line no-await-in-loop -- preserve the retry cadence between status requests.
