/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: def2476ed87054017f924d7182e2912f)
// Runtime types generated with workerd@1.20260623.1 2026-06-26 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	AI_GATEWAY_NAME: "resume-analyze";
	RESUME_OBJECT: DurableObjectNamespace<import("./src/index").ResumeObject>;
	RESUME_INDEX: DurableObjectNamespace<import("./src/index").ResumeIndexObject>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "ResumeObject" | "ResumeIndexObject" | "JobDescriptionObject" | "JobDescriptionIndexObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_NAME">> {}
}
