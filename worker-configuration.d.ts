/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c502f40831b7b2756c3e5de5208b2fd3)
// Runtime types generated with workerd@1.20260623.1 2026-06-26 nodejs_compat
interface __BaseEnv_Env {
	RESUME_ANALYSIS_QUEUE: Queue;
	AI: Ai;
	AI_GATEWAY_NAME: "collects-auto-ai";
	GEMINI_MODEL: "gemini-3.5-flash";
	RESUME_REGISTRY: DurableObjectNamespace<import("./src/index").ResumeRegistryObject>;
	RESUME_DOCUMENT: DurableObjectNamespace<import("./src/index").ResumeDocumentObject>;
	JD_OBJECT: DurableObjectNamespace<import("./src/index").JobDescriptionObject>;
	JD_INDEX: DurableObjectNamespace<import("./src/index").JobDescriptionIndexObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ResumeObject" | "ResumeIndexObject" | "JobDescriptionObject" | "JobDescriptionIndexObject" | "ResumeRegistryObject" | "ResumeDocumentObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_NAME" | "GEMINI_MODEL">> {}
}
